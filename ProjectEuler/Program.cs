...
namespace ProjectEuler
{
    public class Program
    {
        private static void Main(string[] args)
        {
            ...
            {
                return problem.ProblemName.CompareTo("Problem179") == 0;
            ...
            var loaders = new List<IProblemLoader>
            {
                ...
                new ProblemLoader<Problem114>(),

                new ProblemLoader<Problem116>(),
                new ProblemLoader<Problem117>(),
                new ProblemLoader<Problem118>(),

                new ProblemLoader<Problem122>(),

                new ProblemLoader<Problem124>(),
